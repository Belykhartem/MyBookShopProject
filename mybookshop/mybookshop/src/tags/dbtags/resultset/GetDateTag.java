 ...
 * <pre>
 *   &LT;tag>
 *     &LT;name>getDate&LT;/name>
 *     &LT;tagclass>tags.dbtags.resultset.GetDateTag&LT;/tagclass>
...
public class GetDateTag extends BaseDateTimeGetterTag {
  ...
  public int doStartTag() throws JspTagException {
    ...
    try {
      ...
      String date = getDateAsString(position,Types.DATE);
      ...
      if (_attributeName != null) {
        setAttribute(_attributeName, date, _scope);
      } else {
